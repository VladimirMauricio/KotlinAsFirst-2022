 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = deg * 0.0174532 + min * 0.00029074 + sec * 0.00000484
 ...
 */
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Nothing = TODO()
...
fun numberRevert(number: Int): Int {
    ...
    var conversion = 0
    while (value > 0) {
        conversion = 10 * conversion + value % 10
        value /= 10
    }
    return conversion
}
